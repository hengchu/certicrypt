...
Section DMAP.
 ...
 Fixpoint dmap (l:list A) (dl: dlist P1 l) {struct dl} : dlist P2 l :=  
  ...
  | dnil _ => dnil P2
  | @dcons _ _ a l pa dl  => dcons a (f pa) (dmap dl)
  end.
...
Section DFORALL2.
 ...
 Fixpoint dforall2
  ...
  match dla, dlb with
  | dnil _, dnil _ => true
  | @dcons _ _ a la pa dla, @dcons _ _ b lb pb dlb =>
...
Section DFOLD_RIGHT.
 ...
 Fixpoint dfold_right (l:list B) (dlb : dlist P l) {struct dlb} : A :=
  match dlb with
  | dnil _ => a0
  | @dcons _ _ b l pb dlb => f pb (dfold_right dlb)
  end.
...
Section DFOLD_LEFT.
 ...
 Fixpoint dfold_left (l:list B) (dlb : dlist P l) (a0:A) {struct dlb} : A :=
  match dlb with
  | dnil _ => a0
  | @dcons _ _ b l pb dlb => dfold_left dlb (f a0 pb)
  end.
